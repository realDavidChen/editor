...
> 这个插件有个不足的地方就是，显示的提示和编辑器文字的颜色混淆在一起，经常看混了，改善的方法是，给显示的文字，配上背景颜色, 详情请看下面 “Custom Css and Js Loader" 配置的方法， 有点繁琐，配置完成后，效果还不错
...
.vs-dark.monaco-editor .ced-1-TextEditorDecorationType11-4::after,
.hc-black.monaco-editor .ced-1-TextEditorDecorationType11-4::after {
    margin: 1.2em;
    color: rgb(254, 83, 106) !important;
    /* 错误提示=》背景颜色自定义 */
    background-color: black;
    padding: 0 5px;
}
...
vs code 的 class我是通过 help--> developer tools来获取的，有css基础的朋友完全可以对每一项细节进行自定义

6. 每次修改css文件，都需要再次执行 f1 => "Enable Custom css And Js" 才能生效
